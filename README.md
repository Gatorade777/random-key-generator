This is my first project, and the idea is to create a key generator that can be integrated into a Linux program like a key manager. Currently, I use Bitwarden to store my keys.
Keep in mind:
